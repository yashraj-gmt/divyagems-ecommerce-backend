...
public class AuthController {
    ...
    public ResponseEntity<StandardApiResponse<MessageResponse>> register(
            @Valid @RequestBody RegisterRequest request) {

        MessageResponse result = authService.register(request);
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(StandardApiResponse.success("Registration successful", result));
    }
    ...
    public ResponseEntity<StandardApiResponse<AuthResponse>> login(
            @Valid @RequestBody LoginRequest request) {

        AuthResponse result = authService.login(request);
        return ResponseEntity.ok(StandardApiResponse.success("Login successful", result));
    }
    ...
    public ResponseEntity<StandardApiResponse<AuthResponse>> refreshToken(
            @Valid @RequestBody RefreshTokenRequest request) {

        AuthResponse result = authService.refreshToken(request);
        return ResponseEntity.ok(StandardApiResponse.success("Token refreshed", result));
    }
    ...
    public ResponseEntity<StandardApiResponse<MessageResponse>> forgotPassword(
            @Valid @RequestBody ForgotPasswordRequest request) {

        MessageResponse result = authService.forgotPassword(request);
        return ResponseEntity.ok(StandardApiResponse.success("Request processed", result));
    }
    ...
    public ResponseEntity<StandardApiResponse<MessageResponse>> resetPassword(
            @Valid @RequestBody ResetPasswordRequest request) {

        MessageResponse result = authService.resetPassword(request);
        return ResponseEntity.ok(StandardApiResponse.success("Password reset successful", result));
    }
    ...
    public ResponseEntity<StandardApiResponse<MessageResponse>> verifyEmail(
            @RequestParam("token") String token) {

        MessageResponse result = authService.verifyEmail(token);
        return ResponseEntity.ok(StandardApiResponse.success("Email verification complete", result));
    }
    ...
    public ResponseEntity<StandardApiResponse<UserProfileResponse>> getMyProfile() {
        UserProfileResponse result = authService.getMyProfile();
        return ResponseEntity.ok(StandardApiResponse.success("Profile fetched", result));
    }
    ...
    public ResponseEntity<StandardApiResponse<MessageResponse>> changePassword(
            @Valid @RequestBody ChangePasswordRequest request) {

        MessageResponse result = authService.changePassword(request);
        return ResponseEntity.ok(StandardApiResponse.success("Password changed", result));
    }
    ...
    public ResponseEntity<StandardApiResponse<MessageResponse>> logout(
            @Valid @RequestBody RefreshTokenRequest request) {

        MessageResponse result = authService.logout(request);
        return ResponseEntity.ok(StandardApiResponse.success("Logout successful", result));
    }
}
